document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btnMenuToggle && menuLateral) {
    ...
    document.addEventListener("click", (e) => {
      if (menuLateral.classList.contains("ativo") && !menuLateral.contains(e.target)) {
        menuLateral.classList.remove("ativo");
      }
    });

    // Fechar menu ao clicar em links/botões internos (opcional)
    menuLateral.querySelectorAll('.btn-icone:not(.btn-lupa)').forEach(btn => {
  ...
  document.addEventListener("click", () => {
    if (inputBusca && inputBusca.classList.contains("visivel") && !menuLateral.classList.contains('ativo')) {
  ...
  document.addEventListener("click", () => {
    if (filtroMenu && !filtroMenu.classList.contains("hidden")) {
